...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260504191100_MultiAccountFcmTokenSupport")]
    partial class MultiAccountFcmTokenSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.AppointmentServicePackage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ServiceNamesSnapshot")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.ChatThread", b =>
                {
                    ...
                    b.Property<Guid?>("FavoriteContextStoreId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.ServicePackageItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.Setting", b =>
                {
                    ...
                    b.Property<bool>("EnableNotificationSound")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.UserFcmToken", b =>
                {
                    ...
                    b.HasIndex("UserId", "FcmTokenHash")
                        .IsUnique()
            ...
            modelBuilder.Entity("Entities.Concrete.Entities.ServicePackageItem", b =>
                {
                    b.HasOne("Entities.Concrete.Entities.ServicePackage", "Package")
                        .WithMany("Items")
